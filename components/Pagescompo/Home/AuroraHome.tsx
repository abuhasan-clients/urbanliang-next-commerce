        ...
        <>
            ...
            <div className=" ">
                ...
                <div className="mx-auto">
                    ...
                    <p className="text-5xl TITLE_BODONI mt-8 mb-2">SHOP HOME</p>
                    <div className="w-full  flex justify-center mx-auto ">
                    ...
                    <DealOfTheDay />
                    {/* slider  new arrivals*/}
                    <h1 className="text-5xl ml-2  titleMargin   mb-8 TITLE_BODONI">NEW ARRIVALS</h1>
                    <SlickCarousel
                        arrData={imgArr}
                        arrows
                    ...
                    />
                    {/* slider  new arrivals*/}
                    <h1 className="text-5xl ml-2 mb-8 mt-12  TITLE_BODONI">EDITORS CHOICE</h1>
                    <SlickCarousel
                        arrData={imgArr}
                        arrows
                        responsive={responsive}
                    ...
                    <PreOrder />
                    {/* slider  Auction*/}
                    <h1 className="text-5xl ml-2 mb-8 mt-12  TITLE_BODONI">AUCTION</h1>
                    <SlickCarousel
                        arrData={imgArr2}
                        arrows
                        responsive={responsive}
                    ...
                    />
                    {/* home sho end */}
                    <p className="text-5xl mb-8 mt-12 TITLE_BODONI">POPULAR STORES</p>
